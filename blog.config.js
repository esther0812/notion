...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || 'The largest sugar daddy dating site in the world', // 作者简介
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://raw.githubusercontent.com/withAI777/stable_notion_template/main/public/favicon.ico', // blog favicon 配置, 必须使用完整路径，不可以使用诸如/public/favicon.ico的格式，支持在线图片，如 https://img.imesong.com/favicon.png
