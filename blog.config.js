...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '305f7fc9b07a4e44baea244bf8f7dc1b',
  ...
  GREETING_WORDS:
    ...
    'Hello, This is a herpes-only dating community🔥, For Herpes only, Thank you👩‍❤‍👨',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || true, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'HerpesDateSite', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'The largest & Best herpes dating site in the world', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.MPWH.com/?tid=af100001660_hds', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Herpes Dating, Herpes Date Site', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'amberjay889@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || 'https://x.com/herpesdatesite', // 你的twitter个人主页
