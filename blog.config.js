...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Welkom, dit is de grootste Sugar Daddy datingwebsite ter wereld🔥, Registreer nu, en begin gratis met daten👩‍❤‍👨',
  ...
  COMMENT_GISCUS_LANG: process.env.NEXT_PUBLIC_COMMENT_GISCUS_LANG || 'nl-NL', // 你的 Giscus 語言 e.g 'en', 'zh-TW', 'zh-CN', 預設 'en'
