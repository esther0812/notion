...
const BLOG = {
  ...
  AVATAR: process.env.NEXT_PUBLIC_AVATAR || 'https://github.com/JayJ686868/avatar/blob/main/android-chrome-192x192.png', // 作者头像，被notion中的ICON覆盖。若无ICON则取public目录下的avatar.png
