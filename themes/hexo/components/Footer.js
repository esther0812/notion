  ...
  return (
    ...
    >
      ...
      <span className='pl-2 hidden busuanzi_container_site_uv'>
        ...
        <p className='text-xs pt-4 text-light-400 dark:text-gray-400'>Disclaimer: You must be over 19 to join. SugarPapa is not an escort service. SugarPapa does not support escorts or prostitution. Profiles that may violate these terms and services will be banned.</p>
    </footer>
  )
}
